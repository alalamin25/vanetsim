  // cl -EHsc H:\Research\documents\CityModel\Graph\graph1\bsp1.cpp 
#include <stdio.h>
#include <conio.h>
#include <math.h>
...
//	Tmh = Tmr = 60;
	fp = fopen("H:\\Research\\documents\\CityModel\\Graph\\graph1\\bsp_MH_cost.txt","wt");
	if (fp == NULL){
		printf("\n Error");
		return;
	}
	...
	for (i=20;i<=120;i+=20){
		...
		fprintf(fp, "\n%d  ",Nmh);
		//for (j = 60;j<=120;j+=30){
			Tmh = Tmr = 56.80;  // RWP=56.80   //  for City = 70.389;  36 x 24 km
