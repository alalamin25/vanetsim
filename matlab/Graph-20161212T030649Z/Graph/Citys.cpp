  // cl -EHsc H:\Research\documents\CityModel\Graph\citys.cpp
#include <stdio.h>
#include <conio.h>
#include <math.h>
// City ( Sx = Sy =0.2,  K=5, E(u) =4 sec, Vmin= 18 (5m/s), Vmax= 108 (30 m/s)
void main(){
	float Na ;
	float Ns;
	float a[]={36,36,30,30,24,36};		//km , = 36000 meter
	float b[]={36,30,30,24,24,24};		//km, = 24000 meter
